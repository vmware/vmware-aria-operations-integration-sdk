...
class TestHighlights:
    ...
    def constants(self):
        ...
        CONTAINER.previous_stats = {
            "cpu_stats": {
                "cpu_usage": {
                    "total_usage": 1371830000,
                    "usage_in_kernelmode": 102727000,
                    "usage_in_usermode": 1269103000,
                },
                "system_cpu_usage": 1103488650000000,
                "online_cpus": 2,
                "throttling_data": {
                    "periods": 0,
                    "throttled_periods": 0,
        ...
        pytest.REQUEST = Request(
            ...
            json={
                "adapterKey": {
                    ...
                    "objectKind": "HighlightsMP_adapter_instance",
                    "identifiers": [
    ...
    def test_highlight_for_growing_unique_objects(self):
        ...
        growing_unique_objects_overtime = LongCollectionBundle(
            NUMBER_OF_COLLECTIONS, 3600
        )
        ...
        highlight = highlight_object_growth(
            growing_unique_objects_overtime.long_collection_statistics
        )
        assert (
            ResultLevel.WARNING,
            "Objects of type 'HighlightsMP::Growing Object' grew at a rate of 900.00% per hour.",
        ) in highlight.messages
    ...
    def test_highlight_for_growing_unique_objects_extreme_growth(self):
        ...
        assert (
            ResultLevel.WARNING,
            "Objects of type 'HighlightsMP::Growing Object' grew at a rate of 3300.00% per hour.",
        ) in highlight.messages
    ...
    def test_highlight_for_growing_unique_objects_with_low_object_growth(self):
        ...
        for collection in range(10):
            ...
            collection_bundle.collection_number = collection
            growing_unique_objects_overtime.add(collection_bundle)
            _json["result"][0]["key"]["name"] = (
                f"{collection}" if collection % 4 == 0 else "same_object"
            )
        ...
        assert (
            ResultLevel.WARNING,
            "Objects of type 'HighlightsMP::Growing Object' grew at a rate of 400.00% per hour.",
        ) in highlight.messages
    ...
    def test_highlight_for_high_number_of_growing_objects_per_collection(self):
        ...
        highlight = highlight_object_growth(
            increasing_number_of_objects_per_collection.long_collection_statistics
        )
        assert (
            ResultLevel.WARNING,
            "Objects of type 'HighlightsMP::Growing Object' grew at a rate of 900.00% per hour.",
    ...
    def test_metric_highlight(self):
        ...
        highlight = highlight_metric_growth(
            increasing_number_of_metrics_per_collection.long_collection_statistics
        )
        assert (
            ResultLevel.WARNING,
            "Metrics on objects of type 'HighlightsMP::Growing Object' grew at a rate of 900.00% per hour.",
        ) in highlight.messages
    ...
    def test_property_highlight(self):
        ...
        highlight = highlight_property_growth(
            increasing_number_of_properties_per_collection.long_collection_statistics
        )
        assert (
            ResultLevel.WARNING,
            "Properties on objects of type 'HighlightsMP::Growing Object' grew at a rate of 900.00% per hour.",
        ) in highlight.messages
    ...
    def test_property_value_highlight(self):
        ...
        response.is_success = True
        _json = copy.deepcopy(pytest.JSON)
        increasing_number_of_property_values_per_collection = LongCollectionBundle(
            5, 3600
        )
        ...
        assert (
            ResultLevel.ERROR,
            "Property values on objects of 'HighlightsMP::Growing Object' grew at a rate of 900.00% per hour.",
        ) in highlight.messages
    ...
    def test_event_highlight(self):
        ...
        assert (
            ResultLevel.WARNING,
            "Events on objects of type 'HighlightsMP::Growing Object' grew at a rate of 9000.00% per hour.",
        ) in highlight.messages
