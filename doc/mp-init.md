...
demonstrate the VMware Aria Operations Integration SDK.
...
```
Management pack description: This management pack is a proof of concept for the VMware Aria Operations Integration SDK project.
```
