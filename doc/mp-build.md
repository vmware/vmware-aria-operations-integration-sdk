...
the user to sign into one and enter their credentials. By default `mp-build` uses the 'default_container_registry' specified in the global [config.json](congif.md) file. Alternatively, the user can use
