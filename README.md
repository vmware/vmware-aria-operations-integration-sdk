...
* Container registry with read and write access (see [FAQ and Troubleshooting](doc/troubleshooting_and_faq.md#why-do-i-need-a-container-registry?) for additional information).
