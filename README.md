...
Each method is described in the [adapter](doc/adapter.md) documentation. For further guidance on using the template project, consult the [Walkthroughs](#walkthroughs) section.
