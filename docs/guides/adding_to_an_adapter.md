...
from the [Python Adapter Library](../references/python-lib/adapter_instance.md)
...
To create a new object type using the [Python Adapter Library](../references/python-lib/adapter_instance.md)
