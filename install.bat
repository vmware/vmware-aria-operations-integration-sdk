...
call deactivate
echo "Installation completed. Run the following command to activate the virtual environment: %VROPS_SDK_REPO_PATH%\%VIRTUAL_ENV_FILE_NAME%\Scripts\activate.bat"
